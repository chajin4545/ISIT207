window.onload = function() {
    ...
    document.getElementById('porsche').addEventListener('click', function() {
        window.location.href = buildURL('http://localhost:8080/reservation.html', 'Porsche Taycan', '660.00', 'assets/images/porsche_taycan.png');
    });

    document.getElementById('lotus').addEventListener('click', function() {
        window.location.href = buildURL('http://localhost:8080/reservation.html', 'Lotus Emeya', '728.00', 'assets/images/lotus_emeya.png');
    });
};