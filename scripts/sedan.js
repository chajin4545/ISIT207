window.onload = function() {
    ...
    document.getElementById('tesla').addEventListener('click', function() {
        window.location.href = buildURL('http://localhost:8080/reservation.html', 'Tesla Model 3', '160.00', 'assets/images/tesla_model_3_front.png');
    });

    document.getElementById('byd').addEventListener('click', function() {
        window.location.href = buildURL('http://localhost:8080/reservation.html', 'BYD Seal', '128.00', 'assets/images/byd_seal_front.png');
    });
};